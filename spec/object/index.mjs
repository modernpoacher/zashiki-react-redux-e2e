  ...
  describe('Object', () => {
    ...
    describe('Object - Object (String)', () => {
      ...
      before(async () => {
         ...
         * Current stage
         */
        await page.waitForSelector('h1::-p-text(Object (String))')
      ...
      describe('Input', () => {
        before(async () => {
           ...
           *  Next stage
           */
          await page.waitForSelector('h1::-p-text(Object (Number))')
    ...
    describe('Object - Object (Number)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Array - Array))')
    ...
    describe('Object - Object (Array - Array)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Array - Object - String))')
    ...
    describe('Object - Object (Array - Object - String)', () => {
      ...
      describe('Input', () => {
        before(async () => {
           ...
           *  Current stage
           */
          await page.waitForSelector('h1::-p-text(Object (Array - Object - Number))')
    ...
    describe('Object - Object (Array - Object - Number)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Array - Object - Boolean))')
    ...
    describe('Object - Object (Array - Object - Boolean)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Array - Object - Null))')
    ...
    describe('Object - Object (Array - Object - Null)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Object)')
    ...
    describe('Object - Object (Object)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Boolean))')
    ...
    describe('Object - Object (Boolean)', () => {
      ...
      after(async () => {
         ...
         *  Next stage
         */
        await page.waitForSelector('h1::-p-text(Object (Null))')
